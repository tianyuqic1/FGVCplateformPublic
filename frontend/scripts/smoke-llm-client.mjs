...
const normalized = normalizeAssistance({
  ...
  final_category_suggestion: {
    label: "couch",
    rationale: "Visible furniture shape should dominate model top-k.",
  },
...
if (normalized.finalCategorySuggestion.label !== "couch") throw new Error("Final category suggestion missing");
