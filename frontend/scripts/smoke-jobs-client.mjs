  ...
  jobs: [
    {
      ...
      state: "in_progress",
      dataset_id: "bird",
      dataset_version_id: "dataset@014",
      progress_percent: 42,
...
assert(normalized.datasetId === "bird", "normalizes dataset_id");
assert(normalized.datasetVersionId === "dataset@014", "normalizes dataset_version_id");
