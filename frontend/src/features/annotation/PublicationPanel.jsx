...
export function PublicationPanel({ projects, projectId, historyOnly = false }) {
  ...
  return <div className="publication-panel">
    <header className="pub-heading"><div><h2>{historyOnly ? "发布记录" : "待发布区"}</h2><p>检查、发布后，人工确认的样本才会进入可追溯的数据集版本。</p></div><span className="pub-lock">已发布版本的标签不可修改</span></header>
    ...
    </section><section className="pub-card"><h3><span>02</span>目标数据集与划分比例</h3>
