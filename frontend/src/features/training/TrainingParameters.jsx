...
export function TrainingParameters({ form, setForm }) {
  ...
  return <>
    ...
    <details className="fv-parameter-section fv-augmentation-disclosure">
      <summary><strong>数据增强</strong><span className="fv-augmentation-summary">{selectedCount ? `已选 ${selectedCount} 项` : "未启用"}<small>仅训练集</small><Icon name="ChevronDown" size={16} /></span></summary>
      <div className="fv-augmentation-body">
