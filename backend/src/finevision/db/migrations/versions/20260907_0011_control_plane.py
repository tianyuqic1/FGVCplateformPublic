"""add control-plane lifecycle, outbox, and artifact integrity tables
...
def upgrade() -> None:
    # Retire the obsolete review tables through a forward migration so existing
    # database history remains valid.
